...
const STRINGS = {
  ...
  ja: {
    topics: { correction: '内容の訂正', suggest: 'テーマの提案', ad: '広告掲載', license: 'コンテンツ利用許諾', media: '取材のご依頼', other: 'その他' },
    noteDefault: 'できるだけ早くお返事します。',
    noteCorrection: '内容の訂正は最優先で対応します。出典を確認したうえで記事を修正し、最終更新日を更新します。',
    noteCommercial: '協業の形を検討したうえでご連絡します。なお、掲載順やおすすめ枠の販売は行っていません。',
  ...
  ko: {
    topics: { correction: '내용 정정', suggest: '주제 제안', ad: '광고 문의', license: '콘텐츠 이용 허락', media: '취재 문의', other: '기타' },
    noteDefault: '최대한 빨리 답장드리겠습니다.',
    noteCorrection: '내용 정정은 가장 먼저 처리합니다. 출처를 확인한 뒤 글을 고치고 최종 업데이트 날짜를 갱신합니다.',
    noteCommercial: '협업 형태를 검토한 뒤 연락드리겠습니다. 다만 추천 목록이나 노출 순서는 판매하지 않습니다.',
