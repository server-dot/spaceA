        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-20">
          <section className="pt-8 max-w-3xl">
            ...
            <p className="text-sm leading-loose text-paper-secondary mt-3.5 text-balance">
              ...
              <a href="/about" className="text-brand-600 font-bold">
                編輯方針
              </a>
              。
            </p>
          ...
          <section id="form" className="grid grid-cols-1 lg:grid-cols-[1fr_1.05fr] gap-12 items-start pt-11">
            <div>
              ...
              <div className="mt-7 border border-paper-border rounded-2xl overflow-hidden bg-paper-surface">
                <iframe
                  title="積木媒體行銷位置地圖"
          ...
          <section className="pt-14">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
              <div className="bg-paper-surface rounded-2xl p-6">
                <b className="text-[15px] font-bold text-paper-ink">內容更正優先</b>
                <p className="text-sm leading-loose text-paper-secondary mt-2.5">
                  核對來源後更正，並更新文章的最後更新日期；若影響原本結論會加註修正說明。
                </p>
              </div>
              <div className="bg-paper-surface rounded-2xl p-6">
                <b className="text-[15px] font-bold text-paper-ink">一定回信</b>
                <p className="text-sm leading-loose text-paper-secondary mt-2.5">
                  合作洽詢與選題建議都會回覆，若主題已在規劃中會說明時程。
                </p>
              </div>
              <div className="bg-paper-surface rounded-2xl p-6">
                <b className="text-[15px] font-bold text-paper-ink">不做付費推薦</b>
                <p className="text-sm leading-loose text-paper-secondary mt-2.5">
