            ...
            <article className="max-w-3xl">
              ...
              <section id="content" className="mt-14 pt-10 border-t border-paper-border">
                ...
                <ul className="grid mt-6 divide-y divide-[#eeeae2] text-base leading-loose text-paper-body">
                  <li className="py-4">
                    <b className="font-bold text-paper-ink">可以</b>：引用單一段落或數據，並註明來源與原文連結。
                  </li>
                  <li className="py-4">
                    <b className="font-bold text-paper-ink">需要授權</b>：整篇轉載、翻譯、改寫、用於商業出版或訓練商業模型。
                  </li>
                  <li className="py-4">
                    <b className="font-bold text-paper-ink">不可以</b>：移除署名、修改結論後仍標示為 spaceA 的內容。
                  </li>
                </ul>
                ...
                <ul className="grid gap-[18px] mt-6 list-none">
                  <li className="grid grid-cols-[8px_1fr] gap-4 items-start">
                    ...
                    <span className="text-base leading-loose text-paper-body text-balance">
                      醫療、健康、法律與財務相關內容，不能取代專業人員的診斷或建議。
                    </span>
                  </li>
                  <li className="grid grid-cols-[8px_1fr] gap-4 items-start">
                    <span className="w-2 h-2 rounded-full bg-brand-400 mt-3" />
                    <span className="text-base leading-loose text-paper-body text-balance">
                      依本站內容所做的購買或其他決定，其結果由使用者自行承擔。
                    </span>
                  </li>
                  <li className="grid grid-cols-[8px_1fr] gap-4 items-start">
                    <span className="w-2 h-2 rounded-full bg-brand-400 mt-3" />
              ...
              <section id="conduct" className="mt-14 pt-10 border-t border-paper-border">
                ...
                <ul className="grid mt-6 divide-y divide-[#eeeae2] text-base leading-loose text-paper-body">
                  <li className="py-4">以自動化程式大量抓取內容，或以其他方式影響網站正常運作。</li>
                  <li className="py-4">偽造身分寄送不實的更正要求或合作洽詢。</li>
                  <li className="py-4">將本站內容用於誤導消費者的宣傳。</li>
                </ul>
              </section>

              <section className="mt-14 pt-10 border-t border-paper-border">
                <h2 className="text-xs font-bold tracking-wider text-paper-secondary">條款修改與準據法</h2>
