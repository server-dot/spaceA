...
- 生成器又自己塞了一章「做隆鼻手術還是打玻尿酸？」（效果與價格／時間與恢復／何時該選），我大綱給的價格章被推到卡片後面、h3 被改成名詞堆 → 整個對調重寫：第一章「隆鼻價差三倍，差在術式、鼻模與醫師」（一段式 3～8 萬／二段式 8～15 萬／結構式 12～25 萬、山根材料價差、2019 年起隆鼻是衛福部特管辦法列管手術只能專科醫師做），卡片後改成「諮詢前要問清楚的三件事」，SVG 標籤同步改
...
- excerpt 補上；封面 media 496 的副標「精選台北 10 家隆鼻診所細節」那個「細節」怪，沒重生（要的話跑 gen_cover_scene）
- 前台待 ISR；英文版還沒跑
