...
5. **第三篇澳洲一日遊** — 重跑中，post 266 已刪，動筆前先照 `docs/推薦文交件檢查清單.md` 決定「推薦對象」要選產品還是服務（卡片要圖就選產品）
...
- [ ] 寫新文章 — 目前 WordPress 只有 3 篇（都在「行銷」「影音器材」分類），內容太少，熱門排行/分類頁/首頁都撐不起來，要盡快補文章
  ...
  - [ ] 料理包
  - [ ] 醫美
  - [ ] 澳洲旅遊 — 改題「澳洲一日遊怎麼選？2026 精選 8 家在地一日團推薦」重跑中（客戶老墨旅遊主打墨爾本華語 10 人小團一日遊，第一版寫成台灣出發 9 天團比例不對，post 266 已刪）
  - [ ] 巧克力
  - [ ] 南投景點
  - [ ] 膠原蛋白
