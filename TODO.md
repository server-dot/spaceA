...
5. ~~**開始寫第三篇**~~ — 澳洲旅遊已完成（post 266），還剩七個主題，動筆前先照 `docs/推薦文交件檢查清單.md` 決定「推薦對象」要選產品還是服務（卡片要圖就選產品）
...
- [ ] 寫新文章 — 目前 WordPress 只有 3 篇（都在「行銷」「影音器材」分類），內容太少，熱門排行/分類頁/首頁都撐不起來，要盡快補文章
  ...
  - [ ] 料理包
  - [ ] 醫美
  - [x] 澳洲旅遊 — post 266 `/travel/best-australia-tour-agencies/`（推薦文生成器，客戶老墨旅遊；已送 GSC 索引。長汎假期卡片還缺圖，官網被 Imperva CAPTCHA 擋住抓不到）
  - [ ] 巧克力
  - [ ] 南投景點
  - [ ] 膠原蛋白
...
- [x] 旅遊類產品的封面情境 — 澳洲旅遊團（post 266）第一版畫成「書桌上的旅遊手冊＋兩台平板」，徽章也跑成膠囊。`封面圖提示詞` 的 product 情境補上：旅遊團／行程／景點／住宿／餐廳這種沒有實體包裝的產品，主角就是目的地實景，禁止手冊、平板、地圖、相機、書桌；徽章明寫「正圓圖示在上＋文字在下，不要膠囊」。post 266 已用同一套提示詞單獨重生一張（media 277，雪梨歌劇院實景）
