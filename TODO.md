...
- [ ] 還沒查：外泌體 214、除毛膏 547、料理包 527、植牙 380、隆鼻 497、巧克力 308、短影音 187、SEO 112、短影音器材 161
- [ ] 生成器端：官網頁抓不到或抓錯就留空（老協珍、台鹽）、同頁多款產品 LLM 全倒進一張卡（m2）——`官方資訊` 節點要加「只整理跟品牌清單裡 official_url 那一款有關的內容」，抓取失敗要在卡片上明顯標「待人工補」而不是靜靜留空
