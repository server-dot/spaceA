...
## post 214 外泌體保養品 法規體檢（2026-09-24）

全站 16 篇中文文章掃過一遍（法規字眼＋無來源負評），真的有問題的是 214、921、547、817、670、308 六篇，一篇一篇處理。214 先做：

- **選購章那句是錯的**：原文「台灣目前不允許人類細胞來源的外泌體用在一般化妝品上，看到主打『人類幹細胞外泌體』就要提高警覺」——文章自己引的食藥署公告標題是「訂定『申請源自人體細胞之外泌體使用於化粧品之**個案審查**應檢送文件』」，不是不允許，是要送個案審查。等於用不準確的法規敘述去暗示兩個具名品牌違法（大研生醫「臍帶間質幹細胞來源」、艾萬霖「UCMSC-exosome」，兩家官網今天都還是這樣寫，卡片沒抓錯）。已改成：最常見來源是牛奶／植物／非人源培養液；人體細胞來源要走食藥署個案審查、通過才能用；看到標榜人類幹細胞或臍帶間質幹細胞來源的，要看品牌有沒有說明審查狀態
- 使用者決定：**卡片照官網寫的留著**（官網怎麼寫就怎麼寫），網友正負評兩欄也留著，只要「不要太深刻」
- 負評 14 則收斂成官網查得到的中性描述：「外泌體成分標示被質疑不夠明確，常被稱為『外泌體概念』」「行銷與網紅推廣被批誇大」（這兩則還是在客戶 relove 自己那張卡）、「成分標示含皂鹼/SLS 可能引起敏感」「臉部使用會有輕微刺感」「長期效果部分使用者回報不明顯」「價格被多數使用者視為偏高」等
- 「實際使用感受／回購傾向」兩行原本照檢查清單刪掉，**使用者說留著（「不奇怪啊」）已全部補回四語**，句子改成人話、負評收斂（「用後無感或認為行銷過度而不回購」重寫）。檢查清單那條規則已作廢，改成「保留但要改寫」；308、380、497、785、817、921 六篇之前照舊規則刪掉的還沒補回去，要補再說
- 前言補一句價格與成分以官網當期標示為準
- 英日韓（365／406／415）同步：卡片結構對得上，照卡號與 li 位置手改，沒重跑翻譯器。**三篇的 excerpt（meta description 吃這個）還在寫「使用感／回購傾向／臨床データ」**，日文那句甚至是沒翻的「回購傾向」，一併重寫
- 四語都已清快取並確認前台
...
- [x] 2026-09-24 法規與客訴體檢（四語同步）：依鈦那列的「中國醫藥大學腸病毒 71 型抑制」整條刪（非環境用藥不掛抗病毒宣稱），只留中興大學皮膚測試與德國 MEDCERT；依鈦的「誤食無礙」、寵衛高手的「舔食無礙」安全宣稱拿掉；抗菌／消臭／防黴這類效能字全部改成「官網標示」轉述，不用本站口吻背書（成分章的「殺的是製造臭味的細菌」改成「官網標示的作用是抑制產生臭味的細菌」）；FAQ 的「噴完味道會消失」「味道多半不會回來」改條件句；「寵衛高手最貴」改「單瓶價格最高」；毛天使 ISO 22716 那句的貶抑語氣改成中性說明標章層級；木酢的貓咪警語全部標明是官網寫的；前言補一句價格與成分是 2026 年 9 月官網標示、以品牌官網為準。**網友正負評兩欄使用者決定保留**，只把「對化學成分的長期安全性有疑慮」「噴起來無感」「效果不穩」「價格偏高」這類無來源的效果／安全指控換成官網查得到的中性描述（共 14 則）。三語不重跑翻譯器：中英日韓四篇 HTML 結構完全對位（2789 個 token），照節點索引手改 800／801／802，順手修掉韓文版成分章那段被 collapse_ko_names 咬掉的殘句（「약알칼리성이기 무쭤다런ODOUT은」「BTQAether의」）。四語都已清快取
