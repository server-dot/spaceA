...
## 明天（2026-09-12）要做：post 308 黑巧克力禮盒 校稿

post 308 `/food/taiwan-dark-chocolate-guide/` 已由生成器發布（**已上線但沒校過**，先不要送 GSC）。健檢發現要修的，照 `docs/推薦文交件檢查清單.md` 做：

1. **露特 Ruta 是立陶宛品牌（比利時製造）**，標題寫台灣品牌不能留 → 整張換成**香草騎士 85% 戀戀生巧克力** NT$500（`https://shop.vanillaknight.com/nama-chocolate05`，圖已上傳 media 313，1,111 件已賣出、比利時黑巧＋台灣香草籽＋白蘭地提香、冷凍宅配）
2. **TERRA 卡**沒圖沒產品定位、比較表一排破折號 → Choco Flight 環遊世界單品巧克力禮盒 NT$550（Pinkoi `https://www.pinkoi.com/product/6kdnNPGn`，9 產區 70% 黑巧克力片各 6g、附風味輪與提袋；圖已上傳 media 312；營業人是九日風股份有限公司）
3. 價格：TC 巧舖「需洽詢」→ NT$950（20 片 100g）；CHOCOARTS「需洽詢」→ NT$350（128g）；**多儂寫成 NT$88,000** → NT$880（45 片 225g）
4. CHOCOARTS 卡的「主要特色」是免稅宅配、7 折、首單折 200 這種促銷字 → 換成 99.9% 黑巧克力、128g 的產品事實；h3 改「99.9% 黑巧克力禮盒」
5. 妮娜 h3 補產品名（醇濃黑巧克力薄片夾心 12 入 NT$329）；主要特色裡「資料顯示星等標示不一致」拿掉
6. 「實際使用感受／回購傾向」18 行全刪；破折號 3 處
7. 第一章「黑巧克力 vs 綜合糖果禮盒」是外包框架換皮 → 改成這 10 款的真實取捨（片狀 vs 生巧、100% vs 70%、每克單價）
8. 前言照範式重寫（價位帶 NT$329～950、片狀／生巧／夾心三類、台灣可可 vs 進口豆）；前言裡兩個關鍵字錨文字連到妮娜商品頁要拿掉
9. 三大面向內文用實際數字：每克單價（TC 9.5／多儂 3.9／18度C 3.6／Joyce 3.2／CHOCOARTS 2.7／日初 405÷24片）
10. 規格雷區「這些都是值得納入台灣巧克力清單的選項」關鍵字硬塞；總結有「把 黑巧克力禮盒,巧克力禮盒推薦,台灣巧克力 當作搜尋關鍵詞」＋「—Q kangber」簽名，整段重寫
11. 章節 h2「品牌推薦」→「精選10款台灣黑巧克力禮盒推薦」＋目錄
12. 參考資料：食藥署巧克力標示規定兩條留著（[2][3]），其他換成 n8n execution 的 `brandDetails[].reference_links`
13. 封面（media 307）便利貼「可可含量與成／分」斷字，用 `scratchpad/gen_cover283c.py` 那套改標題重生一張，便利貼三行固定「可可含量、」「原料製程、」「每克單價！」；n8n 提示詞已改成「一行一個項目」
14. 修完跑去 AI 味判讀，再送 GSC 索引
...
- [ ] 寫新文章 — 目前 WordPress 只有 3 篇（都在「行銷」「影音器材」分類），內容太少，熱門排行/分類頁/首頁都撐不起來，要盡快補文章
  ...
  - [ ] 巧克力 — post 308 已生成（10 款台灣黑巧克力禮盒，客戶妮娜），2026-09-12 校稿，見最上面
  - [ ] 南投景點
  - [ ] 膠原蛋白
