...
- [ ] 寫新文章 — 十篇交辦只剩寵物用品（2026-09-21 核對；下面清單是進度）
  ...
  - [x] 寵物用品 — post 785 `/pets/best-pet-deodorizing-sprays/`（客戶貝恩，題目定「寵物除臭噴霧」，標題 2026-09-22 改成站上同款式「寵物除臭噴霧怎麼挑？10 款成分、價格與能否噴毛孩一次比」；10 家：貝恩、臭味滾、寵衛高手、汪喵星球、Aether 依鈦、毛天使、淨毒五郎、梧天家、水魔素、木酢達人；2026-09-22 生成＋校稿完成，見下方）
